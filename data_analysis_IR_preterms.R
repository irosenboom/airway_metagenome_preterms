...
spearman_table_b$Type <- "Directed"
...
# export edge list
write.table(spearman_edges_b, file="edges_b.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
# export node list
write.table(spearman_nodes_b, file="nodes_b.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
spearman_table_c$Type <- "Directed"
...
# export edge list
write.table(spearman_edges_c, file="edges_c.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
# export node list
write.table(spearman_nodes_c, file="nodes_c.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
spearman_table_d$Type <- "Directed"
...
# export edge list
write.table(spearman_edges_d, file="edges_d.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
# export node list
write.table(spearman_nodes_d, file="nodes_d.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
spearman_table_full <- spearman_table_full[spearman_table_full$p<0.05,]
...
spearman_table_full$Type <- "Directed"
...
# export edge list
write.table(spearman_edges_full, file="edges_full.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
# export node list
write.table(spearman_nodes_full, file="nodes_full.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
spearman_table_full_m9 <- spearman_table_full_m9[spearman_table_full_m9$p<0.05,]
...
spearman_table_full_m9$Type <- "Directed"
...
# export edge list
write.table(spearman_edges_full_m9, file="edges_full_m9.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
# export node list
write.table(spearman_nodes_full_m9, file="nodes_full_m9.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
spearman_table_full_m15 <- spearman_table_full_m15[spearman_table_full_m15$p<0.05,]
...
spearman_table_full_m15$Type <- "Directed"
...
# export edge list
write.table(spearman_edges_full_m15, file="edges_full_m15.csv", sep=";", col.names = TRUE, row.names = FALSE)
...
# export node list
write.table(spearman_nodes_full_m15, file="nodes_full_m15.csv", sep=";", col.names = TRUE, row.names = FALSE)
